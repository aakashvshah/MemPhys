...
void PARAMETERS::verify_parameters()
{
    ...
    if (strcmp(solver_type.c_str(), "hypre_ilu_gmres") != 0 && strcmp(solver_type.c_str(), "eigen_direct") != 0 && strcmp(solver_type.c_str(), "eigen_ilu_bicgstab") != 0 && strcmp(solver_type.c_str(), "sor") != 0)
    {
        cout << "\n\nERROR from PARAMETERS::verify_parameters solver_type should be either hypre_ilu_gmres, eigen_ilu_bicgstab or eigen_direct or sor; current value: " << solver_type << "\n\n";
        throw bad_exception();
    }
